...
ROOT_DIR = environ.Path(__file__) - 3  # (djangoproject/config/settings/base.py - 3 = djangoproject/)
APPS_DIR = ROOT_DIR.path('djangoproject')
...
MIGRATION_MODULES = {
    'sites': 'djangoproject.contrib.sites.migrations'
}
